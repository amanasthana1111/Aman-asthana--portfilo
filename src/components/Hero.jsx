const Hero = () => {
  return (
    <section className="w-full text-white mt-5">
      <div className="font-['MyFont2']">
        ...
        <p className="text-gray-400 mt-4 leading-relaxed">
          ...
          >
            <a href="https://pre-well-frontend.vercel.app/">
              <span className="leading-none cursor-pointer text-red-600">Folify</span>
            </a>
          </span> modern web platforms , contributing to AI-driven
        ...
        {/* CTA */}
        <p className="text-base text-gray-400 mt-4">
          Open to <span className="font-semibold" >collaborations, internships</span>, engineering
          challenges.
        </p>
      </div>
    </section>
